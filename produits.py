...
def produitsf():
   ...
   with st.form("produits", clear_on_submit=True):
        ...
        produit_img = st.text_input("Télécharger l'image du produit")
        ...
        produit_stk = st.number_input("Entrez la quantité en stock du produit")
        produit_dmd = st.number_input("Entrez la quantité en demande du produit")
